...
export default function WorkspaceGeneral() {
  ...
  return (
    <div className="flex w-full max-w-[600px] flex-col items-start justify-start gap-6 sm:py-8">
      ...
      >
        <FieldGroup>
          <FieldSet className="flex flex-col gap-8">
            ...
            <FieldDescription>
              Edit your workspace's basic settings, such as its name or status.
              You can also delete the workspace if it's no longer needed.
            </FieldDescription>
        ...
        <FieldGroup>
          <FieldSet className="flex flex-col gap-8">
            ...
            <FieldDescription>
              This action will deactivate your workspace. All of your data will
              be preserved, and you can reactivate the workspace later if needed
              from trash section.
            </FieldDescription>
          </FieldSet>
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  will be preserved, and you can reactivate the workspace later
                  if needed from trash section.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
