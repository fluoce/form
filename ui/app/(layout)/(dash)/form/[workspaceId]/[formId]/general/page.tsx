...
export default function FormGeneral() {
    ...
    const { formId, workspaceId } = useParams<{ workspaceId: string, formId: string }>()
    ...
    return (
        <div className="w-full flex flex-col gap-6 items-start justify-start max-w-[600px] sm:py-8">
            ...
            <form onSubmit={handleFormUpdate} className='w-full flex flex-col gap-8'>
                <FieldGroup>
                    <FieldSet className='flex flex-col gap-8'>
                        <FieldLegend>General Form Information</FieldLegend>
                        <FieldDescription>
                            Edit your Form's basic settings, such as its name or status. You can also delete the Form if it's no longer needed.
                        </FieldDescription>
                        <FieldGroup className='max-w-100'>
                            <Field>
                                ...
                                <Input
                                    ...
                                    id="create-form"
                                    placeholder={formData.name ? formData.name : "Enter new form name..."}
                                />
                            </Field>
                            <Field>
                                ...
                                >
                                    <SelectTrigger disabled={isPending || isFetching}>
                                        <SelectValue
                                            placeholder={formData.status ? formData.status : "Select New workspace Status"}
                                        />
                                    </SelectTrigger>
                                    <SelectContent>
                ...
                <FieldGroup>
                    <FieldSet className='flex flex-col gap-8'>
                        ...
                        <FieldDescription>
                            This action will Archive your form. All of your data will be preserved, and you can reactivate the form later if needed from trash section.
                        </FieldDescription>
                    </FieldSet>
                    <AlertDialog>
